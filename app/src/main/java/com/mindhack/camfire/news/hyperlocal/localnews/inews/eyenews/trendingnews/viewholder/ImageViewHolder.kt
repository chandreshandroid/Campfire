...
import com.mindhack.camfire.news.hyperlocal.localnews.inews.eyenews.trendingnews.adapter.FeedItemImageAdapter
...
class ImageViewHolder(itemView: View, context: Activity) : RecyclerView.ViewHolder(itemView) {


    val context = itemView.context
    val linearLayoutManager = LinearLayoutManager(context)
    var feedThreeDots = itemView.feedThreeDots
    var feedItemImageAdapter = FeedItemImageAdapter(context)
    ...
    init {
        ...
        recycle_view_feedhome.adapter = feedItemImageAdapter
