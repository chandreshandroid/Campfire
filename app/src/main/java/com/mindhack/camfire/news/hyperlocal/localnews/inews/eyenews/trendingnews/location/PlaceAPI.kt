...
import com.mindhack.camfire.news.hyperlocal.localnews.inews.eyenews.trendingnews.location.model.Address
...
class PlaceAPI private constructor(
    ...
    internal fun autocomplete(input: String): ArrayList<Place>? {
        ...
        try {
            ...
            sb.append("&types=(state)");
            val url : URL = (URL(sb.toString()))
