...
class LocationListFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if(arguments!=null)
        {
            hashTag=arguments?.getString("location")!!
        }
...
//        (activity as MainActivity).showHideBottomNavigation(false)
    ...
    fun setupViewPager(listpager: ViewPager?) {
        if (viewPagerAdapter == null)
        {
            ...
            viewPagerAdapter?.addFragment(LocationPostListFragment(), ""+GetDynamicStringDictionaryObjectClass?.Recent)
            viewPagerAdapter?.addFragment(LocationPostListFragment(), ""+GetDynamicStringDictionaryObjectClass?.Top)
        }
