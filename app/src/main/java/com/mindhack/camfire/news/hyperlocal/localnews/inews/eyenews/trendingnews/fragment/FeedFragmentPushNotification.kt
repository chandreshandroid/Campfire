 ...
 */
class FeedFragmentPushNotification : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tollOther.visibility = View.VISIBLE
...
//            }
        ...
        getPostListModel =
            ViewModelProviders.of(this@FeedFragmentPushNotification).get(GetPostListModel::class.java)
...
//                                if (sessionManager?.isLoggedIn()!!) {
    ...
    fun getPostList() {
        ...
        getPostListModel?.apiFunction(mActivity!!, false, jsonArray.toString(), "postList")
            ?.observe(this@FeedFragmentPushNotification,
...
//                            }
                            ...
                            if (feedList!!.size == 0) {
                                ...
                                nodata1.text=getString(R.string.nodata1)
                            } else {
                                noDatafoundRelativelayout.visibility = View.GONE
                                feedRecyclerview.visibility = View.VISIBLE
...
//        lp.height = 900
            ...
            ViewCompat.animate(button).translationY((button.height).toFloat())
                ...
                .setListener(object : ViewPropertyAnimatorListener {
                    override fun onAnimationStart(view: View) {
                        this@FeedFragmentPushNotification.mIsAnimatingOut = true
                    }

                    override fun onAnimationCancel(view: View) {
                        this@FeedFragmentPushNotification.mIsAnimatingOut = false
                    }
    ...
    fun setPostViewsCount(feedPos: Int) {
        try {
            if (!feedList?.get(feedPos)?.isYouViewPost?.contains("Yes")!!) {
                ...
                jsonArray.put(jsonObject)
                val postView =
                    ViewModelProviders.of(this@FeedFragmentPushNotification).get(PostViewModel::class.java)
    ...
    override fun onDestroy() {
        ...
        if (feedListAdapter != null) {
            if (feedListAdapter?.cache != null) {
                /* feedListAdapter?.cache?.release()
                 feedListAdapter?.cache = null*/
            }
    ...
    private fun getUserFollow(
        ...
        var getFollowModel = ViewModelProviders.of(this@FeedFragmentPushNotification).get(FollowModel::class.java)
        getFollowModel.apiCall(mActivity!!, jsonArray.toString(), s).observe(this@FeedFragmentPushNotification,
            Observer
            { trendingFeedDatum ->
                if (trendingFeedDatum != null && trendingFeedDatum.isNotEmpty()) {
                    // MyUtils.closeProgress()
    ...
    fun feedLike1(
        ...
        when (s) {
            ...
            if(feedList!![feedPosition]!!.LikeReaction.equals(s))
            {
                if(feedList!![feedPosition]!!.postHaha.toInt()>0)
                {
                    feedDatum.postHaha = (feedList!![feedPosition]!!.postHaha.toInt() - 1).toString()
                    feedDatum.postHaha = (feedList!![feedPosition]!!.postHaha.toInt() + 1).toString()
                }
                else
                {
            ...
            if (feedDatum.postAngry.toInt() > 0) {
                feedDatum.postAngry =
                    (feedList!![feedPosition]!!.postAngry.toInt() - 1).toString()
            } else {
                feedDatum.postAngry = "0"
            }

            if (feedDatum.postSad.toInt() > 0) {
                feedDatum.postSad = (feedList!![feedPosition]!!.postSad.toInt() - 1).toString()
            } else {
                feedDatum.postSad = "0"
            }
            ...
            if (feedDatum.postLike.toInt() > 0) {
                feedDatum.postLike =
                    (feedList!![feedPosition]!!.postLike.toInt() - 1).toString()
            } else {
            ...
            "Sad" -> {
                ...
                if(feedList!![feedPosition]!!.LikeReaction.equals(s))
                {
                    if(feedList!![feedPosition]!!.postSad.toInt()>0)
                    {
                        feedDatum.postSad = (feedList!![feedPosition]!!.postSad.toInt() - 1).toString()
                        feedDatum.postSad = (feedList!![feedPosition]!!.postSad.toInt() + 1).toString()
                    }
                ...
                if (feedDatum.postHaha.toInt() > 0) {
                    feedDatum.postHaha =
                        (feedList!![feedPosition]!!.postHaha.toInt() - 1).toString()
                } else {
            ...
            "Angry" -> {
                ...
                if(feedList!![feedPosition]!!.LikeReaction.equals(s))
                {
                    if(feedList!![feedPosition]!!.postAngry.toInt()>0)
                    {
                        feedDatum.postAngry = (feedList!![feedPosition]!!.postAngry.toInt() - 1).toString()
                        feedDatum.postAngry = (feedList!![feedPosition]!!.postAngry.toInt() + 1).toString()
                    }
                    else
                    {
            ...
            "Like" -> {
                ...
                if(feedList!![feedPosition]!!.LikeReaction.equals(s))
                {
                    if(feedList!![feedPosition]!!.postLike.toInt()>0)
                    {
                        feedDatum.postLike = (feedList!![feedPosition]!!.postLike.toInt() - 1).toString()
                        feedDatum.postLike = (feedList!![feedPosition]!!.postLike.toInt() + 1).toString()
                    }
                    else
                    {
    ...
    fun setPostLike(
        ...
        postLike.apiCall(mActivity!!, jsonArray.toString(), action).observe(
            this@FeedFragmentPushNotification,
    ...
    fun setPostFavourite(
        ...
        val postLike: PostFavouriteModel =
            ViewModelProviders.of((this@FeedFragmentPushNotification)).get(
...
//        lp.height = 900
    ...
    fun getReasonList(postID: String, pos: Int) {
        ...
        val apiCall = ViewModelProviders.of(this@FeedFragmentPushNotification).get(ReasonModel::class.java)
        apiCall.apiFunction(mActivity!!, true, jsonArray.toString()).observe(this@FeedFragmentPushNotification,
    ...
    private fun getPostHide(
        ...
        jsonArray.put(jsonObject)
        var reportPostModel =
            ViewModelProviders.of(this@FeedFragmentPushNotification).get(ReportPostModel::class.java)

        reportPostModel.apiFunction(mActivity!!, jsonArray.toString(), "PostHide")
            .observe(this@FeedFragmentPushNotification, Observer { it ->
                //            MyUtils.closeProgress()
    ...
    fun notifyData(feedDatum: TrendingFeedData, isDelete: Boolean,isDeleteComment:Boolean,postComment:String) {
