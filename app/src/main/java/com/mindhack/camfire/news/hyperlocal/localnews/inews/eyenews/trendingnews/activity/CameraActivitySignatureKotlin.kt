...
class CameraActivitySignatureKotlin : AppCompatActivity(), View.OnClickListener,
    OptionView.Callback {
    ...
    var imageFlash: AppCompatImageView? = null
...
//            val view = OptionView(this@CameraActivityKotlin).
//
//            view.setOption(options[i], this)
...
//            )
        ...
        layoutManager =
            LinearLayoutManager(
                this@CameraActivitySignatureKotlin,
    ...
    private fun CurrentCityName(lattitude: Double, longitude: Double) {
        ...
        geocoder = Geocoder(this@CameraActivitySignatureKotlin, Locale.getDefault())
        ...
        try {
            ...
            if (addresses != null) {
                MyUtils.locationCityName =addresses[0].locality+", "+addresses[0].adminArea+", "+addresses[0].countryName
                MyUtils.locationCityNameFix = addresses[0].locality+", "+addresses[0].adminArea+", "+addresses[0].countryName
    ...
    private fun permissionLocation() {
        if (!addPermission(Manifest.permission.ACCESS_FINE_LOCATION)) {
            ...
            MyUtils.showMessageOKCancel(this@CameraActivitySignatureKotlin,
                message,
...
//                    MyUtils.currentLongitude=location.longitude
    ...
    private fun setActionAdapter() {
        ...
        arrayActionList.add("Video")
//        arrayActionList.add("Photo")
                ...
                override fun onClicklisneter(
                    ...
                    if (pos == 0) {
                        ...
                        if (!isVideo!!) {
                            ...
                            isVideo = true
                            canStopVideo = false
                            capturePicture?.setImageResource(R.drawable.capture_btn_for_video_black_center)
    ...
    private inner class Listener : CameraListener() {
        ...
        override fun onPictureTaken(result: PictureResult) {
            ...
            val intent = Intent(this@CameraActivitySignatureKotlin, CreatePostActivity::class.java)
            ...
            result.toBitmap(1000, 1000) { bitmap ->
                ...
                try {
                    ...
                    MyUtils.finishActivity(this@CameraActivitySignatureKotlin, true)
                } catch (e: IOException) {
                    e.printStackTrace()
                }
            }
...
//              val intent = Intent(this@CameraActivitySignatureKotlin, CreatePostActivity::class.java)
                ...
                retriever.setDataSource(this@CameraActivitySignatureKotlin, Uri.parse(MyUtils.videoPath))
                ...
                val intent1 = Intent()
                intent1.putExtra("VideoFile", MyUtils.videoFile1.toString())
                intent1.putExtra("VideoPath", MyUtils.videoPath.toString())
                setResult(1313, intent1)
                finish()
                ...
                if ((!isVideo!!)) {
                    ...
                    if (canStopVideo!!) {
                        if (counter > 10) {
                            ...
                            this@CameraActivitySignatureKotlin,
                            "Video minimum length required is 5 seconds.",
                            Toast.LENGTH_SHORT
                        ).show()
    ...
    private fun openGallery() {
        if ((!isVideo!!)) {
            ...
            try {
                ...
                Toast.makeText(
                    this@CameraActivitySignatureKotlin, "Please install a File Manager.",
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
...
//        alert.requestWindowFeature(Window.FEATURE_NO_TITLE)
    ...
    override fun onBackPressed() {
        ...
        showMessageOKCancelCustome(this@CameraActivitySignatureKotlin,
            ...
            DialogInterface.OnClickListener { dialogInterface, i ->
                ...
                try {
                    ...
                    this@CameraActivitySignatureKotlin.finish()
                } catch (e: Exception) {
                    e.printStackTrace()
                }
            })
        ...
        mHandler1?.postDelayed(
            {
                ...
                camera!!.takeVideo(File(filesDir, "video$timeStamp.mp4"), 3000)
        ...
        when (requestCode) {
            1211 -> {
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (java.lang.Long.valueOf(duration) <= 5529){
//                        val intent =
//                            Intent(this@CameraActivitySignatureKotlin, CreatePostActivity::class.java)
//                        if ((!isVideo!!))
//                            intent.putExtra("from", "images")
//                        else {
//                            intent.putExtra("from", "video")
...
//                        MyUtils.finishActivity(this@CameraActivitySignatureKotlin, true)
                        ...
                        val intent1 = Intent()
                        intent1.putExtra("VideoFile", MyUtils.videoFile.toString())
                        setResult(1313, intent1 )
                        finish()
                    }else{
                        MyUtils.showSnackbarkotlin(this@CameraActivitySignatureKotlin, root, resources.getString(R.string.err_video_lth_3))
                    }
                }
            }
        }
    ...
    private fun customCompressImage(actualImage: File): File? {
        ...
        try {
            compressedImage = Compressor(this@CameraActivitySignatureKotlin)
                .setMaxWidth(640)
                .setMaxHeight(480)
                .setQuality(75)
    ...
    fun getPathVideo(pictureUri: Uri): String? {
        ...
        try {
            val proj = arrayOf(MediaStore.Images.Media.DATA)
            cursor = this@CameraActivitySignatureKotlin.contentResolver
