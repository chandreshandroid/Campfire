...
private constructor(
    ...
    init {
        requireNotNull(mParentView) { "Parent view may not be null" }
        requireNotNull(mCallback) { "Callback may not be null" }
    ...
    fun settleCapturedViewAt(finalLeft: Int, finalTop: Int): Boolean {
        check(mReleaseInProgress) { "Cannot settleCapturedViewAt outside of a call to " + "Callback#onViewReleased" }
    ...
    fun flingCapturedView(minLeft: Int, minTop: Int, maxLeft: Int, maxTop: Int) {
        check(mReleaseInProgress) { "Cannot flingCapturedView outside of a call to " + "Callback#onViewReleased" }
    ...
    private fun saveInitialMotion(x: Float, y: Float, pointerId: Int) {
        ...
        mInitialMotionY?.set(pointerId, mLastMotionY?.get(pointerId)!!)
    ...
    companion object {
         ...
         */
        fun create(forParent: ViewGroup, cb: Callback): CustomDragHelper {
            return CustomDragHelper(forParent.context, forParent, cb)
        }
         ...
         * @return a new ViewDragHelper instance
         */
        fun create(forParent: ViewGroup, sensitivity: Float, cb: Callback): CustomDragHelper {
