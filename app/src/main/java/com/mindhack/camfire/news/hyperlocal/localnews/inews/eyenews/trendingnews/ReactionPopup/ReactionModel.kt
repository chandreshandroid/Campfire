...
class ReactionsConfigBuilder(val context: Context) {
    ...
    var popupGravity: PopupGravity =
        PopupGravity.DEFAULT

    var popupMargin: Int = horizontalMargin

    var popupColor: Drawable?=null
    ...
    fun withPopupColor(popupColor: Drawable) = this.also {
    ...
    fun withTextColor( textColor: Int) = this.also {
