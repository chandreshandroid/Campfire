package com.mindhack.camfire.news.hyperlocal.localnews.inews.eyenews.trendingnews.cameraview;
            ...
            if (started) {
                view.addCameraListener(new CameraListener() {
                    ...
                    public void onCameraClosed() {
                        ...
                        view.setEngine(com.otaliastudios.cameraview.controls.Engine.CAMERA2);
                        view.open();
                    }
                });
                view.close();
